...
class DebateWorkflow:
    ...
    async def run_optimist_rebuttal(self):
        ...
        {self.optimist_result.output.argument}

        Opposing Argument:
        {self.skeptic_result.output.argument}
    ...
    async def run_skeptic_rebuttal(self):
        ...
        Optimist Rebuttal:
        {self.optimist_rebuttal.output.argument}
    ...
    async def run_judge(self):
        ...
        Skeptic Rebuttal:
        {self.skeptic_rebuttal.output.argument}
